...
```shell
git clone https://github.com/DMill31/streaming-01-foundations
...
The modification for this project is not a very impactful one as this is only Project 1.
...
This simplifies the discount_code column.
