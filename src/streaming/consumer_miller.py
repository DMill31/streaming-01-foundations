"""src/streaming/consumer_miller.py - Local consumer
...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m streaming.consumer_miller
"""
...
def process_message(row: dict[str, Any]) -> dict[str, Any]:
    ...
    row["used_discount"] = bool(row["discount_code"])

    dt = datetime.now().fromisoformat(row["datetime"].replace("Z", "+00:00"))
